...
func (dc *DepositCreate) SetStatus(d deposit.Status) *DepositCreate {
...
func (dc *DepositCreate) SetUserID(id uuid.UUID) *DepositCreate {
	dc.mutation.SetUserID(id)
	return dc
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (dc *DepositCreate) SetNillableUserID(id *uuid.UUID) *DepositCreate {
	if id != nil {
		dc = dc.SetUserID(*id)
	}
	return dc
...
func (dc *DepositCreate) SetUser(u *User) *DepositCreate {
...
func (dc *DepositCreate) Save(ctx context.Context) (*Deposit, error) {
	dc.defaults()
	return withHooks[*Deposit, DepositMutation](ctx, dc.sqlSave, dc.mutation, dc.hooks)
}
...
func (dc *DepositCreate) check() error {
	...
	if _, ok := dc.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`ent: missing required field "Deposit.status"`)}
	}
